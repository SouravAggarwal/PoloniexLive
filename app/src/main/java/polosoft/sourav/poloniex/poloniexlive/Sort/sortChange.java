...
public class sortChange implements Comparator<ListObj> {


    @Override
    public int compare(ListObj o1, ListObj o2) {
        double d1 = new Double(Double.parseDouble(o1.gethJsonPerChange()));
        double d2= new Double(Double.parseDouble(o2.gethJsonPerChange()));
